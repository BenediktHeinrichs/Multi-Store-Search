  ...
  <div>
    <b-navbar toggleable="lg" class="bg-dark" data-bs-theme="dark">
      <router-link v-slot="{ href }" to="/" custom>
        <b-navbar-brand :href="href">Multi Store Search</b-navbar-brand>
      </router-link>
      ...
      <b-collapse id="nav-collapse" is-nav>
        <b-navbar-nav>
          <router-link v-slot="{ href, isExactActive }" to="/" custom>
            <b-nav-item :href="href" :active="isExactActive">Search</b-nav-item>
          </router-link>
        </b-navbar-nav>
